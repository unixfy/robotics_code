...
/*
HAVE SOME dab dab sb dabda dab dab db da b dab dab dab dab dab dba bd abd abd abd abd abdb q
-------------------------------------------------------------
...
task autonomous()
{
	...
	// Close Yellow Cone Grabber on preload, then stop
	motor[coneGrab] = 127;
	wait1Msec(550);
        motor[coneGrab] = 0;
	...
	// Move Scissor Lift up for .6 seconds, then stop
